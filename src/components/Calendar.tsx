...
import { format, startOfMonth, endOfMonth, eachDayOfInterval, startOfWeek, endOfWeek, isSameMonth, isSameDay, addMonths, subMonths, setMonth, setYear, getYear, getMonth } from 'date-fns';
      ...
      <div className={styles.header}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          <select
            ...
            className={styles.monthTitle} // Reusing style for font size
